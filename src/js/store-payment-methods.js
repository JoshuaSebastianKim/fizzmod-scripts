...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(64), __webpack_require__(18), __webpack_require__(19), __webpack_require__(22), __webpack_require__(57), __webpack_require__(1), __webpack_require__(68), __webpack_require__(108), __webpack_require__(171)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_extends2, _getPrototypeOf, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _inherits2, _react, _reactDom, _lodash) {
		...
		/**
	  * Model of the payment methods
	  * @type {Array}
	  */
		var paymentMethodsConf = [{
			region: "mendoza",
			paymentMethods: {
				credit: ["diners", "cabal", "americanexpress", "visa", "naranja", "mastercard"],
				debit: ["americanexpress", "visa", "mastercard"]
			}
		}, {
			region: "tucuman",
			paymentMethods: {
				credit: ["diners", "cabal", "americanexpress", "visa", "naranja"],
				debit: ["americanexpress", "visa", "mastercard"]
			}
		}, {
			region: "neuquen",
	  ...
	  */
		var PaymentMethod = function PaymentMethod(props) {
			return _react2.default.createElement(
				'div',
				{ className: 'payment-methods__region' },
				_react2.default.createElement(
					'div',
					{ className: 'payment-methods__region-name' },
					props.region
				),
				_react2.default.createElement(
					'div',
					{ className: 'payment-methods__method-types' },
					_lodash2.default.map(props.paymentMethods, function (cards, method) {
						return _react2.default.createElement(
							'div',
							{ key: method, className: 'payment-methods__method' },
							_react2.default.createElement(
								'div',
								{ className: 'payment-methods__method-type' },
								method === "credit" ? "Tarjetas de Crédito" : "Tarjetas de Débito"
							),
							_react2.default.createElement(
								'div',
								{ className: 'payment-methods__cards' },
								cards.map(function (card) {
									return _react2.default.createElement(
										'div',
										{ key: card, className: 'payment-methods__card' },
										_react2.default.createElement('div', { className: 'card card--' + card })
									);
								})
							)
						);
	  ...
	  */
		...
		var PaymentMethods = function (_React$Component) {
			(0, _inherits3.default)(PaymentMethods, _React$Component);

			function PaymentMethods() {
				(0, _classCallCheck3.default)(this, PaymentMethods);
				return (0, _possibleConstructorReturn3.default)(this, (PaymentMethods.__proto__ || (0, _getPrototypeOf2.default)(PaymentMethods)).apply(this, arguments));
			}
			...
			(0, _createClass3.default)(PaymentMethods, [{
				...
				value: function render() {
					return _react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'payment-methods__header' },
							_react2.default.createElement(
								'div',
								{ className: 'payment-methods__header-title' },
								'Medios de pago'
							)
						),
						_react2.default.createElement(
							'div',
							{ className: 'payment-methods__regions' },
							paymentMethodsConf.map(function (method, index) {
								return _react2.default.createElement(PaymentMethod, (0, _extends3.default)({ key: index }, method));
							})
						)
					);
				}
		...
		_reactDom2.default.render(_react2.default.createElement(PaymentMethods, null), document.getElementById('store-payment-methods-root'));
