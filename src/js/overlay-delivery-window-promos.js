...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(64), __webpack_require__(18), __webpack_require__(19), __webpack_require__(22), __webpack_require__(57), __webpack_require__(1), __webpack_require__(68)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_getPrototypeOf, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _inherits2, _react, _reactDom) {
		'use strict';
		...
		var vtexjs = window.vtexjs;
		var janis = window.janis;
		...
		var Header = function Header(props) {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'overlay__header-title' },
					props.title
				),
				_react2.default.createElement(
					'div',
					{ className: 'overlay__header-subtitle' },
					props.subtitle
				)
			);
		};

		var PostalCode = function (_React$Component) {
			(0, _inherits3.default)(PostalCode, _React$Component);

			function PostalCode() {
				(0, _classCallCheck3.default)(this, PostalCode);
				return (0, _possibleConstructorReturn3.default)(this, (PostalCode.__proto__ || (0, _getPrototypeOf2.default)(PostalCode)).apply(this, arguments));
			}

			(0, _createClass3.default)(PostalCode, [{
				key: 'render',
		...
		var Overlay = function (_React$Component2) {
			(0, _inherits3.default)(Overlay, _React$Component2);
			...
			(0, _createClass3.default)(Overlay, [{
				...
				value: function componentDidMount() {
					this.getDeliveryWindows();
				}
			}, {
				key: 'getDeliveryWindows',
				value: function getDeliveryWindows() {
					$.ajax({
						url: '' + janis.BASE_URL + janis.GET_STORES,
				...
				value: function render() {
					var headerProps = {
						title: "Horarios de Entregas",
						subtitle: "Consultá nuestros horarios de entrega para Retiro en Sucursales o Envío a Domicilio"
					};

					return _react2.default.createElement(
						'div',
						{ className: 'delivery-window-promos' },
						_react2.default.createElement(Header, headerProps),
						_react2.default.createElement(
							'div',
							{ className: 'overlay' },
							_react2.default.createElement(PostalCode, null)
						)
					);
				}
			}]);
		...
		_reactDom2.default.render(_react2.default.createElement(Overlay, null), document.getElementById('delivery-window-promos-root'));
